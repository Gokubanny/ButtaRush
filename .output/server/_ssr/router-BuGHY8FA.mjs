...
import { i as SiteHeader, r as SiteFooter } from "./butta-rush-site-D2etNZ2A.mjs";
import { t as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BuGHY8FA.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-ENPUvzo0.css";
...
var Route$1 = createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			property: "og:description",
			content: "Home-style Nigerian dishes, cakes and pastries made to order. Browse the menu and order on WhatsApp."
		},
		{
			property: "og:type",
			content: "website"
...
var Route = createFileRoute("/menu")({
	head: () => ({ meta: [
		...
		{
			property: "og:description",
			content: "Browse cakes, pastries, meals and trays from Butta Rush. Order directly on WhatsApp."
		},
		{
			property: "og:type",
			content: "website"
